			     ...
			     u8 rcpi)
{
	...
	if (sta->ht_cap.ht_supported) {
		phy->ampdu =
			FIELD_PREP(IEEE80211_HT_AMPDU_PARM_FACTOR, sta->ht_cap.ampdu_factor) |
			FIELD_PREP(IEEE80211_HT_AMPDU_PARM_DENSITY, sta->ht_cap.ampdu_density);
	}
...
int mt76_connac_sta_state_dp(struct mt76_dev *dev,
	...
	mt76_connac_mcu_set_deep_sleep(dev, dp);
				      ...
				      struct ieee80211_vif *vif)
{
	...
	bool suspend = test_bit(MT76_STATE_WOW, &phy->state);
